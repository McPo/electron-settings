...
class Settings extends EventEmitter {
  ...
  _readSettingsFileSync() {
    ...
    try {
			const obj = Encryptor.readEncryptedJsonSync(pathToSettings);
  ...
  _writeSettingsFileSync(obj, options) {
    ...
    if (opts.atomicSaving) {
      ...
      try {
        Encryptor.outputEncryptedJsonSync(tmpFilePath, obj);
      ...
      fs.renameSync(tmpFilePath, pathToSettings);
			...
			Encryptor.outputEncryptedJsonSync(pathToSettings, obj);
